...
#define DEVICE_RELATE_START_ADDR 		(0x3600)     //EEPROM存储地址
#define DEVICE_AIRCONDITION_START_ADDR	(0x4000)     //EEPROM空调存储地址
...
/*******************************************************************************
**函    数： AirCondition_SaveRelateData
**功    能： 空调面板保存关联数据数据到EEPROM
**参    数： void
**返    回： void
*******************************************************************************/
...
void AirCondition_FullShow(void)
{
	...
	else OLED_ShowHalfPicAt(4,PicTab[46]);           //空调关闭图片
